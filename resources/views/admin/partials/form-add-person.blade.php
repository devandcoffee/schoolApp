...
@if (isset($config))
    ...
    <div class="form-group{{ $errors->has('mobile_phone') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" name="mobile_phone" id="mobile_phone" placeholder="{{ __('messages.persons.mobile_phone') }}">
        </div>
    </div>
    <div class="form-group{{ $errors->has('home_phone') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" name="home_phone" id="home_phone" placeholder="{{ __('messages.persons.home_phone') }}">
        </div>
    </div>
@endif
</div>